...
$lang = array_merge($lang, [
	...
	'ACP_MOT_DIAGNOSIS_CONFIRM_ITEM_DEL'	=> [
		...
		2	=> 'Wollen Sie wirklich %1$d Einträge aus der ATTACHMENTS_TABLE löschen?<br><br>Damit werden die Einträge endgültig aus der Datenbank entfernt, <strong>dieser Vorgang kann nicht rückgängig gemacht werden!</strong>',
	],
	...
	'ACP_MOT_DIAGNOSIS_CONFIRM_FILE_DEL'	=> [
		...
		2	=> 'Wollen Sie wirklich %1$d Dateien aus dem Verzeichnis `/files` löschen?<br><br>Damit werden die Dateien endgültig gelöscht, <strong>dieser Vorgang kann nicht rückgängig gemacht werden!</strong>',
	],
